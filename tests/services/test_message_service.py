...
def test_parse_message_simple_text(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
    ...
    message = message_service.parse_message(raw_message_str)
...
def test_parse_message_sync_message(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
            "sourceNumber": "+1234567890",
...
def test_parse_message_edit_message(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_remote_delete(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_reaction(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_group_message(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_attachment(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
...
def test_parse_message_mention(message_service: MessageService) -> None:
    raw_message = {
        "envelope": {
            "source": "+1234567890",
