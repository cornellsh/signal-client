...
from signalbot.infrastructure.api_clients.accounts_client import AccountsClient


@pytest.fixture
def accounts_client(mock_session):
    return AccountsClient(mock_session, "http://localhost:8080")


@pytest.mark.asyncio
async def test_get_accounts(accounts_client: AccountsClient, mock_session):
...
@pytest.mark.asyncio
async def test_set_pin(accounts_client: AccountsClient, mock_session):
...
@pytest.mark.asyncio
async def test_remove_pin(accounts_client: AccountsClient, mock_session):
    phone_number = "+1234567890"
...
@pytest.mark.asyncio
async def test_lift_rate_limit(accounts_client: AccountsClient, mock_session):
    phone_number = "+1234567890"
...
@pytest.mark.asyncio
async def test_update_settings(accounts_client: AccountsClient, mock_session):
    phone_number = "+1234567890"
...
@pytest.mark.asyncio
async def test_set_username(accounts_client: AccountsClient, mock_session):
    phone_number = "+1234567890"
...
@pytest.mark.asyncio
async def test_remove_username(accounts_client: AccountsClient, mock_session):
    phone_number = "+1234567890"
