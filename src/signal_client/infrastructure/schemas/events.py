...
class ReceiptEvent(BaseEvent):
    ...
    @classmethod
    def normalize_timestamps(cls, value: Any) -> list[int]:
        if value is None:
            return []
...
class TypingEvent(BaseEvent):
    ...
    @classmethod
    def normalize_action(cls, value: Any) -> TypingAction:
...
class BlockEvent(BaseEvent):
    ...
    @classmethod
    def normalize_blocked(cls, value: Any) -> bool:
